    ...
    switch (parseInt(pais)) {
        case 1: //Estados unidos se toma con la vigencia del plan e ilimitado no importan redes
            if (date != false) {
                ...
                if (dias >= 1 && dias <= 5) {
                    mostrarAlerta(
                        "El plan recomendado: EEUU - 2 GB Diarias - $25"
                    );
                } else if (parseInt(dias) > 5 && parseInt(dias) <= 7) {
                    mostrarAlerta(
                        "El plan recomendado: EEUU TM - Ilimitado LOCAL 07 días - $35 + Llamadas a EEUU"
                    );
                } else if (parseInt(dias) > 7 && parseInt(dias) <= 12) {
                    mostrarAlerta(
                        "El plan recomendado: EEUU TM - Ilimitado LOCAL 12 días - $40+ Llamadas a EEUU"
                    );
                } else if (parseInt(dias) > 12 && parseInt(dias) <= 15) {
                    mostrarAlerta(
                        "El plan recomendado: EEUU TM - Ilimitado LOCAL 15 días - $45 + Llamadas a EEUU"
                    );
                } else if (parseInt(dias) > 15 && parseInt(dias) <= 20) {
                    mostrarAlerta(
                        "El plan recomendado: EEUU TM - Ilimitado LOCAL 20 días - $50 + Llamadas a EEUU"
                    );
                } else if (parseInt(dias) > 20 && parseInt(dias) <= 30) {
                    mostrarAlerta(
                        "El plan recomendado: EEUU TM - Ilimitado LOCAL 30 días - $55 + Llamadas a EEUU"
                    );
        ...
        case 3: //Global Sim
            if (frecuente == "0") {
                mostrarAlerta(
                    "Error: Seleccione una opción de aplicaciones de uso frecuente",
                    true
                );
            ...
            if (ambos_datos != false) {
                mostrarAlerta(
                    "Error: Global Sim solo es un plan de datos, Selecciona opción datos.",
                    true
                );
            }
            break;
        case 4: //Panamá
            if (date != false) {
                ...
                if (dias >= 1 && dias <= 7) {
                    ...
                    mostrarAlerta(
                        "Error: Recuerda que el plan tiene vigencia 7 días",
                        true
                    );
                }
            }
        ...
        case 5: //Ecuador
            if (date != false) {
                mostrarAlerta(
                    "Error: Ecuador no cuenta con plan de datos, Selecciona la opción llamadas y datos",
                    true
                );
            }
            if (frecuente == "0") {
        ...
        case 6: //República Dominicana
            ...
            if (frecuente == "0") {
                ...
                mostrarAlerta(
                    "El plan recomendado: República Dominica - 5 GB - $30 Vigencia 5 días"
                );
                ...
                mostrarAlerta(
                    "El plan recomendado: República Dominica - 10 GB - $35 Vigencia 10 días"
                );
            } else if (date != false && frecuente == "alto" && dias > 10) {
                mostrarAlerta(
                    "El plan recomendado: República Dominica - 10 GB - $35 Vigencia 10 días"
        ...
        case 8: //Aruba, Bonaire, Curazao
            ...
            if (frecuente == "0") {
                ...
                mostrarAlerta(
                    "El plan recomendado: Aruba, Bonaire y Curazao - 2 GB - $25 Vigencia 3 días"
                );
                ...
                mostrarAlerta(
                    "El plan recomendado: Aruba, Bonaire y Curazao - 5 GB - $40 Vigencia 7 días"
                );
            } else if (date != false && frecuente == "alto" && dias > 7) {
                mostrarAlerta(
                    "El plan recomendado: Aruba, Bonaire y Curazao - 5 GB - $40 Vigencia 7 días"
        ...
        case 10: //Eurodata
            ...
            if (frecuente == "0") {
                ...
                mostrarAlerta(
                    "El plan recomendado: Eurodata - 30 GB - $30 Vigencia 28 días + minutos ilimitados"
                );
            } else if (
                ambos_datos != false &&
                frecuente == "medio" &&
                ...
                mostrarAlerta(
                    "El plan recomendado: Eurodata - 50 GB - $35 Vigencia 28 días + minutos ilimitados"
                );
            } else if (
                ambos_datos != false &&
                frecuente == "alto" &&
                ...
                mostrarAlerta(
                    "El plan recomendado: Eurodata - 95 GB - $40 Vigencia 28 días + minutos ilimitados"
                );
            } else if (
                ambos_datos != false &&
                frecuente == "muyalto" &&
        ...
        case 12: //Turquia por GB
            ...
            if (date != false) {
                if (frecuente == "bajo" && parseInt(dias) <= 5) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 3 GB  $25 Vigencia 30 días"
                    );
                } else if (frecuente == "bajo" && parseInt(dias) <= 10) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 5 GB - $35 Vigencia 30 días"
                    );
                } else if (frecuente == "medio" && parseInt(dias) <= 10) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 5 GB  $35 Vigencia 30 días"
                    ...
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 10 GB  $50 Vigencia 30 días"
                    );
                } else if (frecuente == "medio" && parseInt(dias) <= 30) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 20 GB  $50 Vigencia 30 días"
                    );
                } else if (frecuente == "alto" && parseInt(dias) <= 30) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 20 GB  $50 Vigencia 30 días"
            ...
            if (ambos_datos != false) {
                mostrarAlerta(
                    "Error: Turquía solo es un plan de datos,  Selecciona opción Tipo de Uso - Datos",
                    true
                );
            }
            break;
        case 13: //Turquia por dias
            if (date != false) {
                if (frecuente == "bajo" && parseInt(dias) <= 5) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 300 MB  $4 por día"
                    );
                } else if (frecuente == "bajo" && parseInt(dias) <= 10) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 500 MB  $5 por día"
                    );
                } else if (frecuente == "bajo" && parseInt(dias) <= 15) {
                    mostrarAlerta(
                        "El plan recomendado: Turquía - 1 GB  $6 por día"
                    );
                }
        ...
        case 14: //Emiratos Arabes Dias
            if (date != false) {
                if (frecuente == "bajo") {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 200 MB - $6 por día"
                    );
                } else if (frecuente == "medio") {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 300 MB - $7 por día"
                    );
                } else if (frecuente == "alto") {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 500 MB - $10 por día"
                    );
                } else if (frecuente == "muyalto") {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 1 GB - $16 por día"
                    );
                }
            }
            if (ambos_datos != false) {
        ...
        case 15: //Emiratos Arabes GB
            if (date != false) {
                if (frecuente == "bajo" && parseInt(dias) <= 5) {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 2 GB - $35 Vigencia 5 días"
                    );
                } else if (frecuente == "bajo" && parseInt(dias) <= 10) {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 3 GB - $45 Vigencia 10 días"
                    );
                } else if (frecuente == "medio" && parseInt(dias) <= 10) {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 5 GB - $65 Vigencia 10 días"
                    );
                } else if (frecuente == "medio" && parseInt(dias) <= 15) {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 8 GB - $85 Vigencia 15 días"
                    );
                } else if (frecuente == "alto" && parseInt(dias) <= 15) {
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 8 GB - $85 Vigencia 15 días"
                    ...
                    mostrarAlerta(
                        "El plan recomendado: Emiratos Arabes - 10 GB - $105 Vigencia 15 días"
                    );
                }
            }
            if (ambos_datos != false) {
        ...
        case 16: //China
            ...
            if (frecuente == "0") {
                ...
                mostrarAlerta(
                    "El plan recomendado: China - 8 GB - $40 Vigencia 15 días"
                );
            } else if (date != false && frecuente == "bajo" && dias <= 30) {
                mostrarAlerta(
                    "El plan recomendado: China - 10 GB - $45 Vigencia 30 días"
                );
