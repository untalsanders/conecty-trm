...
formulario.addEventListener('submit', function(evento){
    ...
    switch (parseInt(pais)) {
        case 1: //Estados unidos se toma con la vigencia del plan e ilimitado no importan redes
            if(date != false){ //por datos
            ...
            }else if(ambos_datos != false){ //llamadas y datos
                if ((parseInt(dias)) >= 1 && (parseInt(dias))<=5){
                    ...
                    mostrarAlerta("El plan recomendado: EEUU TM - Ilimitado INTL 8 días - $40 + llamadas a EEUU y llamadas a Colombia");
                    }else if((parseInt(dias)) > 8 && (parseInt(dias)) <=12){;
                        mostrarAlerta("El plan recomendado: EEUU TM - Ilimitado INTL 12 días - $45 + llamadas a EEUU y llamadas a Colombia");
                        }else if((parseInt(dias)) > 12 && (parseInt(dias)) <=15){
                            mostrarAlerta("El plan recomendado: EEUU TM - Ilimitado INTL 15 días - $50 + llamadas a EEUU y llamadas a Colombia");
                            }else if((parseInt(dias)) > 15 && (parseInt(dias)) <=20){    
                                mostrarAlerta("El plan recomendado: EEUU TM - Ilimitado INTL 20 días - $55 + llamadas a EEUU y llamadas a Colombia");
                                }else if((parseInt(dias)) > 20 && (parseInt(dias)) <=30){        
                                    mostrarAlerta("El plan recomendado: EEUU TM - Ilimitado INTL 30 días - $60 + llamadas a EEUU y llamadas a Colombia");
                                    }else if((parseInt(dias)) >=30){            
                                        mostrarAlerta("El plan recomendado: EEUU TM - Ilimitado INTL 30 días - $60 + llamadas a EEUU y llamadas a Colombia");
                                    }
            }
        ...
        case 2: //México
            if(date != false){
                if (frecuente =='bajo' && (parseInt(dias))<=8){
                    mostrarAlerta("El plan recomendado: México - 2.5 GB SOLO DATOS - $25 + Redes Sociales que no consumen de tus datos");
                    }else if (frecuente =='bajo' && (parseInt(dias)) <=15){
                        mostrarAlerta("El plan recomendado: México - 3.5 GB SOLO DATOS - $30 + Redes Sociales que no consumen de tus datos");
                        }else if (frecuente =='bajo' && (parseInt(dias)) <=30){
                            mostrarAlerta("El plan recomendado: México - 5 GB SOLO DATOS - $35 + Redes Sociales que no consumen de tus datos");
                            }else if (frecuente =='medio' && (parseInt(dias)) <=30){
                                mostrarAlerta("El plan recomendado: México - 8 GB - $45 + Redes Sociales que no consumen de tus datos");
                                }else if (frecuente =='alto' && (parseInt(dias)) <=30){
                                    mostrarAlerta("El plan recomendado: México - 12 GB - $60 + Redes Sociales que no consumen de tus datos");
                                    }else if (frecuente =='muyalto' && (parseInt(dias)) <=30){
                                        mostrarAlerta("El plan recomendado: México - 14 GB - $75 + Redes Sociales que no consumen de tus datos");
                                        }else if (frecuente =='bajo' || frecuente =='medio' || frecuente =='alto' || frecuente =='muyalto' && (parseInt(dias)) > 30){
                                            mostrarAlerta("El plan recomendado: México - 14 GB - $75 + Redes Sociales que no consumen de tus datos");
                                            }
            }            
            if(ambos_datos != false){
                if (frecuente =='bajo' && (parseInt(dias))<=5){
                    mostrarAlerta("El plan recomendado: México - 3 GB SOLO DATOS - $25 Vigencia 5 días + 1700 minutos + Redes Sociales que no consumen de tus datos ");
                    }else if (frecuente =='bajo' && (parseInt(dias))<=10){
                        mostrarAlerta("El plan recomendado: México - 6 GB SOLO DATOS - $30 Vigencia 10 días + 1700 minutos + Redes Sociales que no consumen de tus datos ");
                        }else if (frecuente =='bajo' && (parseInt(dias))<=15){
                            mostrarAlerta("El plan recomendado: México - 10 GB SOLO DATOS - $35 Vigencia 15 días + 1700 minutos + Redes Sociales que no consumen de tus datos ");
                            }else if (frecuente =='bajo' && (parseInt(dias))<=30){
                                mostrarAlerta("El plan recomendado: México - 10 GB SOLO DATOS - $35 Vigencia 15 días + 1700 minutos + Redes Sociales que no consumen de tus datos, La vigencia de estos planes son de 5, 10 y 15 días");
        ...
        case 4: //Panamá
            if(date != false){
                mostrarAlerta("Error: Panamá no cuenta con planes de datos, por favor selecciona la opción llamada y datos",true);
            }else if(ambos_datos != false){
                if(dias >=1 && dias <=7){
                    mostrarAlerta("El plan recomendado: Panamá - Ilimitado 07 días - $25 Vigencia 7 días + 25 minutos locales o a Colombia");
                }else {
        ...
        case 5: //Ecuador
            ...
            if(frecuente == '0'){
                ...
                mostrarAlerta("El plan recomendado: Ecuador - 10 GB - $30 Vigencia 30 días + 100 minutos locales o a Colombia");
                }else if(ambos_datos != false && frecuente == 'medio' && dias <= 30){
                    mostrarAlerta("El plan recomendado: Ecuador - 10 GB - $30 Vigencia 30 días + 100 minutos locales o a Colombia");
                    }else if(ambos_datos != false && frecuente == 'alto' && dias <= 30){
                        mostrarAlerta("El plan recomendado: Ecuador - 15 GB - $35 Vigencia 30 días + 400 minutos locales o a Colombia");
        ...
        case 6: //República Dominicana
            if(ambos_datos != false){
                mostrarAlerta("Error: República Dominicana no cuenta con plan de llamadas, Selecciona la opción Datos.", true);
            }
            if(frecuente == '0'){
                mostrarAlerta("Error: Seleccione una opción de aplicaciones de uso frecuente", true);
        ...
        case 7: //Colombia
        if(date != false){
            mostrarAlerta("Error: Colombia no cuenta con plan de datos, Selecciona la opción llamadas y datos", true);
        }
        if(frecuente == '0'){
            mostrarAlerta("Error: Seleccione una opción de aplicaciones de uso frecuente", true);
        }else if(ambos_datos != false && frecuente == 'bajo' && dias <= 15){
            mostrarAlerta("El plan recomendado: Conecty Colombia - 14 GB - $30 Vigencia 30 días + minutos ilimitados + WhatsApp ilimitado");
            }else if(ambos_datos != false && frecuente == 'bajo' && dias <= 22){
                mostrarAlerta("El plan recomendado: Conecty Colombia - 22 GB - $35 Vigencia 30 días + minutos ilimitados + WhatsApp ilimitado");
                }else if(ambos_datos != false && frecuente == 'medio' && dias <= 30){
                            mostrarAlerta("El plan recomendado: Conecty Colombia - 32 GB - $40 Vigencia 30 días + minutos ilimitados + WhatsApp ilimitado");
                            }else if(ambos_datos != false && frecuente == 'alto' && dias <= 30){
                                mostrarAlerta("El plan recomendado: Conecty Colombia - 50 GB - $45 Vigencia 30 días + minutos ilimitados + WhatsApp ilimitado");
                                }else if(ambos_datos != false && frecuente == 'muyalto' && dias <= 30){
                                    mostrarAlerta("El plan recomendado: Conecty Colombia - Ilimitado - $50 Vigencia 30 días + minutos ilimitados + WhatsApp ilimitado");
                                    }
            
            break;
        case 8: //Aruba, Bonaire, Curazao
            if(ambos_datos != false){
                mostrarAlerta("Error: Aruba, Bonaire y Curazao no cuenta con plan de llamadas, Selecciona la opción Datos.", true);
            }
            if(frecuente == '0'){
                mostrarAlerta("Error: Seleccione una opción de aplicaciones de uso frecuente", true);
        ...
        case 9: //Argentina
            if(date != false){
                mostrarAlerta("Error: Argentina no cuenta con plan de datos, Selecciona la opción llamadas y datos", true);
            }
            if(frecuente == '0'){
                mostrarAlerta("Error: Seleccione una opción de aplicaciones de uso frecuente", true);
            }else if(ambos_datos != false && frecuente == 'bajo' && dias <= 30){
                mostrarAlerta("El plan recomendado: Argentina - 6 GB - $35 Vigencia 30 días + 1000 minutos locales + WhatsApp ilimitado");
                }else if(ambos_datos != false && frecuente == 'bajo' && dias > 30){
                    mostrarAlerta("El plan recomendado: Argentina - 6 GB - $35 Vigencia 30 días + 1000 minutos locales + WhatsApp ilimitado");
                    }else if(ambos_datos != false && frecuente == 'medio' && dias <= 30){
                        mostrarAlerta("El plan recomendado: Argentina - 6 GB - $35 Vigencia 30 días + 1000 minutos locales + WhatsApp ilimitado");
                            ...
                            mostrarAlerta("El plan recomendado: Argentina - 6 GB - $35 Vigencia 30 días + 1000 minutos locales + WhatsApp ilimitado");
                                ...
                                mostrarAlerta("El plan recomendado: Argentina - 12 GB - $40 Vigencia 30 días + 2000 minutos locales + WhatsApp ilimitado");
                            }else if(ambos_datos != false && frecuente == 'alto' && dias > 30){
                                mostrarAlerta("El plan recomendado: Argentina - 12 GB - $40 Vigencia 30 días + 2000 minutos locales + WhatsApp ilimitado");
                                }else if(ambos_datos != false && frecuente == 'muyalto' && dias <= 30){
                                    mostrarAlerta("El plan recomendado: Argentina - 12 GB - $40 Vigencia 30 días + 2000 minutos locales + WhatsApp ilimitado");
        ...
        case 10: //Eurodata
            if(date != false){
                mostrarAlerta("Error: Eurodata no cuenta con plan de datos, Selecciona la opción llamadas y datos", true);
            }
            if(frecuente == '0'){
                mostrarAlerta("Error: Seleccione una opción de aplicaciones de uso frecuente", true);
        ...
        case 11: //Eurotravel
            if(date != false){
                mostrarAlerta("Error: Eurotravel no cuenta con plan de datos, Selecciona la opción llamadas y datos", true);
            }
            if(frecuente == '0'){
                mostrarAlerta("Error: Seleccione una opción de aplicaciones de uso frecuente", true);
            }else if(ambos_datos != false && frecuente == 'bajo' && dias <= 7){
                mostrarAlerta("El plan recomendado: Eurotravel - S 7 GB - $25 Vigencia 28 días + 300 minutos + Bono España 18 GB");
                }else if(ambos_datos != false && frecuente == 'bajo' && dias <= 10){
                    mostrarAlerta("El plan recomendado: Eurotravel - M 10 GB - $30 Vigencia 28 días + 800 minutos + Bono España 40 GB");
                    }else if(ambos_datos != false && frecuente == 'medio' && dias <= 13){
                        mostrarAlerta("El plan recomendado: Eurotravel - L 13 GB - $35 Vigencia 28 días + minutos ilimitados + Bono España 87 GB");
                        }else if(ambos_datos != false && frecuente == 'medio' && dias <= 20){
                            mostrarAlerta("El plan recomendado: Eurotravel - XL 20 GB - $40 Vigencia 28 días + minutos ilimitados + Bono España 100 GB");
                            }else if(ambos_datos != false && frecuente == 'alto' && dias <= 20){
                                mostrarAlerta("El plan recomendado: Eurotravel - XL 20 GB - $40 Vigencia 28 días + minutos ilimitados + Bono España 100 GB");
                                }else if(ambos_datos != false && frecuente == 'alto' && dias <= 30){
                                    mostrarAlerta("El plan recomendado: Eurotravel - XXL 30 GB - $50 Vigencia 28 días + minutos ilimitados + Bono España 120 GB");
                                    }else if(ambos_datos != false && frecuente == 'muyalto' && dias <= 30){
                                        mostrarAlerta("El plan recomendado: Eurotravel - XXL 30 GB - $50 Vigencia 28 días + minutos ilimitados + Bono España 120 GB");
                                        }
            break;
        ...
        case 14: //Emiratos Arabes Dias
            ...
            if(ambos_datos != false){
                    mostrarAlerta("Error: Emiratos Arabes solo es un plan de datos, Selecciona opción Tipo de Uso Datos",true);
                }
        ...
        case 16: //China
            if(ambos_datos != false){
                mostrarAlerta("Error: China, Hong Kong (HK) Y MACAO no cuenta con plan de llamadas, Selecciona la opción Datos.", true);
            }
            if(frecuente == '0'){
                mostrarAlerta("Error: Seleccione una opción de aplicaciones de uso frecuente", true);
